...
This project is a fullstack Whats app clone project (front:react,back:nodejs/express)
I have use material ui for UI
...
You have to add Your own URIS in config file (both Front and back) because I changed Uri and Api keys if you dont project wont work
...
you can change page color mode (light/dark)
